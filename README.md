...
This repository contains a small, stranger-runnable example of a verifier-backed publication workflow.
...
The demo verifies a fixed-observation Ohm's Law boundary artifact and its associated test surface.

It does not claim new physics, universal scientific validation, peer review, or external adoption.

Adoption status:

This is a runnable adoption surface for outsider evaluation. External adoption is not claimed until an independent user or project runs and uses the workflow.
